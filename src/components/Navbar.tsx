...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] w-full max-w-[760px] px-4">
      ...
      */}
      <nav className="flex items-center justify-between px-4 py-2 rounded-full bg-[#111111]/30 backdrop-blur-[40px] backdrop-saturate-[180%] border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
        ...
        <a 
          ...
          className="flex items-center space-x-1.5 px-4 py-1.5 rounded-full border border-white/20 text-xs md:text-sm font-medium mix-blend-difference text-white hover:bg-white hover:text-black hover:mix-blend-normal transition-all relative z-10 ml-auto"
        >
          <span>Resume</span>
