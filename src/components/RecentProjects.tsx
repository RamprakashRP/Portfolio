          ...
          {topProjects.slice(0, 4).map((project, idx) => {
            ...
            return (
              <Link
                ...
                key={idx}
                className={`${spans.colSpan} ${spans.rowSpan} bg-[#09090a] border border-white/10 rounded-2xl md:rounded-3xl p-3 md:p-6 h-[220px] md:h-[450px] flex flex-col justify-end group relative overflow-hidden cursor-pointer hover:border-white/20 transition-colors shadow-2xl`}
              >
